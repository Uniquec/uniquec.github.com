window.BMAP_AUTHENTIC_KEY = "PXwUIv07VUauf8un2uLEPSw9";
(function () {
    ...
    var qa = window.BMap_loadScriptTime, ra = (new Date).getTime(), sa = p, ta = o, ua = 5042, va = 5002, wa = 5003, xa = "load_mapclick", ya = 5038, za = 5041, Ba = 5047, Ca = 5036, Da = 5039, Fa = 5037, Ga = 5040, Ha = 5011, Ia = 7E3;
    var Ja = 0;
    ...
    x.extend(Ka.prototype, {
        va: function () {
            ...
            var b = this;
            if (a instanceof H)b.ui(a, {noAnimation: o}); else if (Za(a))if (b.Ib === Oa) {
                var c = E.fC[a];
                c && (pt = c.m, b.Wf(pt))
            } else {
                var d = this.HH();
            ...
            z.An("cus.fire", "time", {z_loadscripttime: ra - qa});
            var c = this;
            if (Za(a))if (c.Ib === Oa) {
                var d = E.fC[a];
                d && (pt = d.m, c.Dd(pt, b))
            ...
            this.K.Ko = o;
            this.In || (this.In = new bb({ZK: o}), this.Xg(this.In))
        }, fW: function () {
            this.K.Ko = q;
            ...
            var d = [];
            a instanceof db ? (d.push(a.of()), d.push(a.se())) : d = a.slice(0);
            ...
            a ? this.js && this.js.Af === a || (this.yh(this.js), this.js = new lb({geotableId: a}), this.Xg(this.js)) : this.yh(this.js)
        }, Vb: function () {
            var a = this.fa() >= this.K.RF && this.pa() === La && 18 >= this.fa(), b = q;
            try {
    ...
    function qb(a) {
        var b = {duration: 1E3, Gc: 30, Go: 0, jc: rb.xM, Bt: s()};
        this.$f = [];
    ...
    void function (a, b, c) {
        void function (a, b, c) {
            ...
            var C = c.alog;
            if (!C || !C.Fo) {
                var B = b.all && a.attachEvent, D = C && C.wE || +new Date, A = a.o3 || (+new Date).toString(36) + Math.random().toString(36).substr(2, 3), G = 0, J = {}, L = function (a) {
    ...
    var Rb = {
        ...
        style: "0xzqoa",
        tile: "ugnana",
        vectordrawlib: "xevvnm",
        newvectordrawlib: "beysig",
        ...
        navictrl: "stzg2q",
        geoctrl: "bp3pmg",
        copyrightctrl: "1hmbkd",
        citylistcontrol: "t51eee",
        scommon: "01qrtb",
        local: "vnoesr",
        route: "xjtc4d",
        othersearch: "ij5ycu",
    ...
    x.object.extend(I, {
        ...
        O3: {},
        gG: {XP: z.ma + "getmodules?v=2.0&t=20140707", yU: 5E3},
        CC: q,
        Pd: {rl: {}, Cn: [], Qv: []},
        load: function (a, b, c) {
            var d = this.ib(a);
    ...
    function gb(a, b) {
        a && (this.Lb = a, this.ba = "spot" + gb.ba++, b = b || {}, this.Ug = b.text || "", this.wv = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.sJ = b.userData || p, this.Qh = b.minZoom || p, this.Ff = b.maxZoom || p)
    }
    ...
    x.extend(Sb.prototype, {
        initialize: function (a) {
            ...
            if (this.q1 || !Wa(a) || isNaN(a) || a < Tb || 3 < a)a = this.defaultAnchor;
            this.k = this.k || {Ag: q};
    ...
    x.object.extend(db.prototype, {
        yj: function () {
            ...
            return !(a instanceof db) || this.yj() ? q : this.se().nb(a.se()) && this.of().nb(a.of())
    ...
    z.Ue(function (a) {
        ...
        a.addEventListener("removeoverlay", function (a) {
            a = a.target;
            if (a instanceof eb)delete b.wa[a.ba]; else for (var d = 0, e = b.Be.length; d < e; d++)if (b.Be[d] === a) {
                b.Be.splice(d, 1);
                break
            }
        });
    ...
    function yc(a, b) {
        var c = this;
        xc() && (a === j && aa(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype.toString.call(a) && aa(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {}, eb.apply(c, arguments), c.ea = {ia: a}, c.z = {
            shape: b.shape || vc,
            size: b.size || wc,
    ...
    x.extend(Fc.prototype, {
        ra: function () {
            ...
            var d = this.map, e = d.pa(), f = d.Oa, g = d.mc, i = e.Ac(f), k = this.mL(), l = k[0], m = k[1], n = k[2], t = k[3], v = k[4], c = "undefined" != typeof c ? c : 0, e = e.k.Pb, k = d.ba.replace(/^TANGRAM_/, "");
            ...
            var a = this.map, b = a.pa(), c = b.aE(a.Oa), d = a.mc, e = Math.ceil(d.lng / c), f = Math.ceil(d.lat / c), b = b.k.Pb, c = [e, f, (d.lng - e * c) / c * b, (d.lat - f * c) / c * b];
            ...
            k && k.Hb ? (ub(k.Hb, b), d && (d = new Q(a[0], a[1]), f = this.map.K.ue ? this.map.K.ue.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k.loaded ? this.yf() : Jc(k, function () {
                e.yf()
            })) : (k = this.ej[g]) && k.Hb ? (c.Qb.insertBefore(k.Hb, c.Qb.lastChild), this.wg[g] = k, ub(k.Hb, b), d && (d = new Q(a[0], a[1]), f = this.map.K.ue ? this.map.K.ue.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k.loaded ? this.yf() : Jc(k, function () {
                e.yf()
                ...
                if (a.rh == 0) {
                    ...
                    if (ta) {
                        if (qa && ra && sa) {
                            ...
                            z.An("cus.fire", "time", {z_imgfirstloaded: b - sa})
                        }
                        ta = q
                    }
                }
            ...
            for (var g = 0; g < c; g++) {
                ...
                if (!i.$H && !(i.lp && !this.map.Vb() || i.jM && this.map.Vb())) {
                    ...
                    var t = e.Ac(m), k = e.aE(m), l = Math.ceil(f.lng / k), v = Math.ceil(f.lat / k), w = e.k.Pb, k = [l, v, (f.lng - l * k) / k * w, (f.lat - v * k) / k * w], n = k[0] - Math.ceil((d.width / 2 - k[2]) / w), l = k[1] - Math.ceil((d.height / 2 - k[3]) / w), v = k[0] + Math.ceil((d.width / 2 + k[2]) / w), y = 0;
                    e === Oa && 15 == d.fa() && (y = 1);
            ...
            if (c instanceof bb)a && !c.Em && (c.ra(this.map, this.ld), c.Em = o); else if (c.Yf && this.map.Xg(c.Yf), c.lp) {
            ...
            var b = this.map.pa();
            if (!this.map.Vb() && (a ? this.map.K.t_ = a : a = this.map.K.t_, a))for (var c = p, c = "2" == z.Oy ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Jm[d]; d++)if (e.g_ == o) {
                b.k.$b = 18;
    ...
    var Rc = [z.url.proto + z.url.domain.TILES_YUN_HOST[0] + "/georender/gss", z.url.proto + z.url.domain.TILES_YUN_HOST[1] + "/georender/gss", z.url.proto + z.url.domain.TILES_YUN_HOST[2] + "/georender/gss", z.url.proto + z.url.domain.TILES_YUN_HOST[3] + "/georender/gss"], Sc = z.url.proto + z.url.domain.main_domain_nocdn.baidu + "/style/poi/rangestyle", Tc = 100;
    ...
    lb.prototype.getTilesUrl = function (a, b) {
        var c = a.x, d = a.y, e = this.pc, c = Rc[Math.abs(c + d) % Rc.length] + "/image?grids=" + c + "_" + d + "_" + b + "&q=" + e.Vm + "&tags=" + e.gu + "&filter=" + e.filter + "&sortby=" + e.Gy + "&ak=" + this.pc.Sl + "&age=" + e.tw + "&page_size=" + e.tN + "&format=" + e.B_;
            ...
            if (!b || !c || !c.lngLat || !c.panoInstance)d(); else {
                ...
                this.co.cC(b, function (b) {
                    b ? e.co.qj(c.lngLat, ae.nP, function (b) {
                        if (b && b.id) {
                            var f = b.id, k = b.uh, b = b.vh, l = bc.Ud.mh(c.lngLat), m = e.cS(l, {
                                x: k,
                                y: b
    ...
    var je = ee ? "-" + ee.toLowerCase() + "-" : "", le = ke("transform"), ne = ke("transitionProperty"), oe = ke("transitionDuration"), ue = ke("transformOrigin"), ve = ke("transitionTimingFunction"), we = ke("transitionDelay"), Dd = /android/gi.test(navigator.appVersion), xe = /iphone|ipad/gi.test(navigator.appVersion), ye = /hp-tablet/gi.test(navigator.appVersion), ze = ke("perspective") in de, Ae = "ontouchstart" in window && !ye, Be = ee !== q, Ce = ke("transition") in de, De = "onorientationchange" in window ? "orientationchange" : "resize", Ee = Ae ? "touchstart" : "mousedown", Fe = Ae ? "touchmove" : "mousemove", Ge = Ae ? "touchend" : "mouseup", He = Ae ? "touchcancel" : "mouseup", Ie = ee === q ? q : {
        ...
        }, Ke = window.cancelRequestAnimationFrame || window.K4 || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout, Le = ze ? " translateZ(0)" : "";
    ...
    Me.prototype = {
        ...
        $u: function (a) {
            if (!(Ae && 0 !== a.touches.length)) {
                var b = this, c = Ae ? a.changedTouches[0] : a, d, e, f = {Ba: 0, time: 0}, g = {
                    Ba: 0,
                    time: 0
                ...
                if (b.Wk)d = b.scale * b.np, d = Math.max(b.options.Vk, d), d = Math.min(b.options.Vp, d), b.np = d / b.scale, b.scale = d, b.x = b.dy - b.dy * b.np + b.x, b.y = b.ey - b.ey * b.np + b.y, b.Ob.style[oe] = "200ms", b.Ob.style[le] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + Le, b.Wk = q, b.refresh(), b.options.sp && b.options.sp.call(b, a); else {
                    if (b.qh) {
    ...
    var Pe = [0, 1, 2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 4, 5, 5, 5, 6, 6, 7, 8, 8, 8, 9, 10], Qe = "\u5176\u4ed6 \u6b63\u95e8 \u623f\u578b \u8bbe\u65bd \u6b63\u95e8 \u9910\u996e\u8bbe\u65bd \u5176\u4ed6\u8bbe\u65bd \u6b63\u95e8 \u8bbe\u65bd \u89c2\u5f71\u5385 \u5176\u4ed6\u8bbe\u65bd".split(" ");
    z.Rm(function (a) {
        var b = p;
        ...
        Kk: function (a) {
            ...
            if (this.Li)a = this.jL(this.Oi), this.qQ.innerHTML = a; else {
                ...
                x.M(d, "mouseover", function () {
                    ...
                    new qb({
                        Gc: 60, jc: rb.Cs, duration: 300, va: function (c) {
    ...
    Re.prototype = {
        ra: function () {
            ...
            new qb({
                Gc: 60, jc: rb.Cs, duration: 300, va: function (d) {
    ...
    S(window, {BMAP_NORMAL_MAP: La, BMAP_PERSPECTIVE_MAP: Oa, BMAP_SATELLITE_MAP: Ya, BMAP_HYBRID_MAP: Ra});
    var Te = R.prototype;
